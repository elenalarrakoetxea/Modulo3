...
namespace Scaffolding.Controllers
{
    public class CocktailsController : Controller
    {
        ...
        public CocktailsController(ScaffoldingContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Alcohol")] Cocktail cocktail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Alcohol")] Cocktail cocktail)
        {
            if (id != cocktail.Id)
            {
                return NotFound();
